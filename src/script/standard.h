...
/** opreturn type. See https://xdisk.org/wiki/datacarrier */
enum DatacarrierType : unsigned int {
    ...
    //! See https://xdisk.org/wiki/datacarrier/bind-plotter
    DATACARRIER_TYPE_BINDPLOTTER = 0x00000010,
    //! See https://xdisk.org/wiki/datacarrier/rental
    DATACARRIER_TYPE_RENTAL      = 0x00000011,
    //! See https://xdisk.org/wiki/datacarrier/contract
    DATACARRIER_TYPE_CONTRACT    = 0x00000012,
    //! See https://xdisk.org/wiki/datacarrier/text
