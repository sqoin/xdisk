...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // xdisk: URIs or payment requests:
...
int main(int argc, char *argv[])
{
    ...
    /// 6. Determine availability of data directory and parse xdisk.conf
    ...
    // xdisk: links repeatedly have their payment requests routed to this process:
