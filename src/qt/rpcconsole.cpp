...
void RPCConsole::updateWalletInfo()
{
    ...
    if (!primaryAddress.isEmpty() && !IsInitialBlockDownload()) {
        ...
        if (!accountID.IsNull()) {
            ...
            ui->primaryAddressBalance->setText(BitcoinUnits::formatWithUnit(BitcoinUnits::xdisk, balance, false, BitcoinUnits::separatorAlways));
            ...
            if (fMiningEnabled) {
                ...
                ui->miningRequireBalance->setText(BitcoinUnits::formatWithUnit(BitcoinUnits::xdisk, balanceRequire, false, BitcoinUnits::separatorAlways));
