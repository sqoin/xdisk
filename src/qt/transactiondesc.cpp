...
QString AddLinkToAddress(const QString &address) {
    return "<a href=\"https://xdisk.org/explorer/address/" + address + "\">" + address + "</a>";
}

QString AddLinkToTx(const QString &tx) {
    return "<a href=\"https://xdisk.org/explorer/tx/" + tx + "\">" + tx + "</a>";
}
...
QString TransactionDesc::toHTML(CWallet *wallet, CWalletTx &wtx, TransactionRecord *rec, int unit)
{
    ...
    // Message from normal xdisk:URI (xdisk:123...?message=example)
