...
QVariant AddressTableModel::data(const QModelIndex &index, int role) const
{
    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            ...
            return BitcoinUnits::formatWithUnit(BitcoinUnits::xdisk, rec->amount - rec->loanAmount - rec->bindPlotterAmount, false, BitcoinUnits::separatorNever);
        case LockedAmount:
            return BitcoinUnits::formatWithUnit(BitcoinUnits::xdisk, rec->bindPlotterAmount + rec->loanAmount, false, BitcoinUnits::separatorNever);
        case LoanAmount:
            return BitcoinUnits::formatWithUnit(BitcoinUnits::xdisk, rec->loanAmount, false, BitcoinUnits::separatorNever);
        case BorrowAmount:
            return BitcoinUnits::formatWithUnit(BitcoinUnits::xdisk, rec->borrowAmount, false, BitcoinUnits::separatorNever);
        }
    }
    ...
    else if (role == Qt::ToolTipRole)
    {
        ...
        case BorrowAmount:
            return tr("Spendable: %1;Locked: %2;Loan to: %3;Borrow from: %4;Available for mining: %5")
                    .arg(BitcoinUnits::formatWithUnit(BitcoinUnits::xdisk, rec->amount - rec->bindPlotterAmount - rec->loanAmount, false, BitcoinUnits::separatorNever),
                        BitcoinUnits::formatWithUnit(BitcoinUnits::xdisk, rec->bindPlotterAmount + rec->loanAmount, false, BitcoinUnits::separatorNever),
                        BitcoinUnits::formatWithUnit(BitcoinUnits::xdisk, rec->loanAmount, false, BitcoinUnits::separatorNever),
                        BitcoinUnits::formatWithUnit(BitcoinUnits::xdisk, rec->borrowAmount, false, BitcoinUnits::separatorNever),
                        BitcoinUnits::formatWithUnit(BitcoinUnits::xdisk, rec->amount - rec->loanAmount +rec->borrowAmount, false, BitcoinUnits::separatorNever))
                    .replace(";", "\n");
        }
    }
    return QVariant();
