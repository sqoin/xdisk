...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s xdisk-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  xdisk-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xdisk transaction") + "\n" +
              "  xdisk-tx [options] -create [commands]   " + _("Create hex-encoded xdisk transaction") + "\n" +
              "\n";
