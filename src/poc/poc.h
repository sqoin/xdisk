...
/**
 * xdisk base target when target spacing is 1 seconds
 * 
 * See https://xdisk.org/wiki/The_Proof_of_Capacity#Base_Target
 *
 ...
 */
static const uint64_t xdisk_BASE_TARGET_1 = 4398046511104ULL;

/**
 * Get basetarget for give target spacing
 */
inline uint64_t GetBaseTarget(int targetSpacing) {
    return xdisk_BASE_TARGET_1 / targetSpacing;
}
 ...
 * @param pOldMiningRequireBalance  Only in xdiskIP004. See https://xdisk.org/wiki/xdiskIP/004#getminingrequire
 * @param params                    Consensus params
 *
 * @return Required balance
 */
