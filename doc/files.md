...
* xdisk.conf: contains configuration settings for xdiskd or xdisk-qt
* xdiskd.pid: stores the process id of xdiskd while running
...
* debug.log: contains debug information and general logging generated by xdiskd or xdisk-qt
