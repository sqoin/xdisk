...
This will build xdisk-qt as well if the dependencies are met.
...
If you want to build xdisk-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a xdisk-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip xdiskd" to strip the debug
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, xdisk should be built with a non-executable stack
...
This example lists the steps necessary to setup and build a command line only, non-wallet distribution of the latest changes on Arch Linux:
    ...
    git clone https://github.com/xdisk/xdisk.git xdisk-src
    cd xdisk-src/
    ./autogen.sh
