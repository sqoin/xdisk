...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 Xdisk from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 Xdisk in block rewards plus fees, but
        ...
        # Send 10 Xdisk with subtract fee from amount
        ...
        # Sendmany 10 Xdisk with subtract fee from amount
